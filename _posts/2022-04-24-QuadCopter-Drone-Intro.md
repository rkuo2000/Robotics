...
* [Stabilize](https://ardupilot.org/copter/docs/stabilize-mode.html#stabilize-mode)
* [Altitude Hold](https://ardupilot.org/copter/docs/altholdmode.html#altholdmode)
...
* [RTL (Return-to-Launch)](https://ardupilot.org/copter/docs/rtl-mode.html#rtl-mode)
...
* [Acro](https://ardupilot.org/copter/docs/acro-mode.html#acro-mode)
* [AirMode](https://ardupilot.org/copter/docs/airmode.html#airmode)
* [Heli_Autorotate](https://ardupilot.org/copter/docs/traditional-helicopter-autorotation-mode.html#traditional-helicopter-autorotation-mode) for traditional helicopters only.
* [AutoTune](https://ardupilot.org/copter/docs/autotune.html#autotune): automatically tune the Stabilize P, Rate P and D, and maximum rotational acceleration
* [Brake](https://ardupilot.org/copter/docs/brake-mode.html#brake-mode)
* [Circle](https://ardupilot.org/copter/docs/circle-mode.html#circle-mode)
* [Drift](https://ardupilot.org/copter/docs/drift-mode.html#drift-mode)
* [Flip](https://ardupilot.org/copter/docs/drift-mode.html#drift-mode)
* [FlowHold](https://ardupilot.org/copter/docs/flowhold-mode.html#flowhold-mode)
...
* [Land](https://ardupilot.org/copter/docs/land-mode.html#land-mode)
* [PosHold (穩停)](https://ardupilot.org/copter/docs/poshold-mode.html#poshold-mode)
...
* [Avoid_ADSB](https://ardupilot.org/copter/docs/common-ads-b-receiver.html#common-ads-b-receiver)
  - ADS-B (aka Automatic Dependent Surveillance Broadcast) 
